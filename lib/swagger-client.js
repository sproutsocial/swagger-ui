...
SwaggerClient.prototype.buildFromSpec = function(response) {
  ...
  // sort the OperationGroups by tag in alphabetical order
  this.apisArray = _.sortBy(this.apisArray, function(o) { return o.tag; })
...
Operation.prototype.execute = function(arg1, arg2, arg3, arg4, parent) {
  ...
  // hack to get &pretty poked on to get prettified json
  log("obj.url = " + obj.url);
  if (obj.url.indexOf('?') > 0)
    obj.url = obj.url + "&pretty=42";
  else
    obj.url = obj.url + "?&pretty=42";
  log("obj.url = " + obj.url);
